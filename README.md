# Credits, this descriptions of commands taken from course https://www.udacity.com/course/version-control-with-git--ud123 and learngitbranching.js.org 
<a href="https://www.udacity.com/course/version-control-with-git--ud123" rel="nofollow">Version Control with Git</a>
...
# switch to sidebar branch and then git log —oneline or git branch commands could help to check active branch if there isn`t # any specific configuration in shell prompt to check it.
